...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        caminhoField.setText("localhost");
        ...
        portaField.setText("6666");
        portaField.setToolTipText("");
    ...
    private void cadastrarButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cadastrarButtonActionPerformed
        this.currentUser = new ItemUser(this.getUserName());
        System.out.println(this.currentUser);
        // logica de conectar no servidor
        this.tcpClient = new TCPClient(this.getCaminhoCadastro(), Integer.parseInt(this.getPorta()));
        this.tcpClient.start();

        if(this.tcpClient.isConnected()) {
            try {
                String clientName = this.currentUser.getNome();
                this.tcpClient.sendMessage(new Message(MessageType.CONNECT, clientName, clientName, null));
            } catch (EOFException e) {
                e.printStackTrace();
            }

            Chat telaChat = new Chat(this.currentUser, this.tcpClient);
